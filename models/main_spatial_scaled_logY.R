# Model definition
description = "Main Model: All Predictors; Spatial"
...
# Some values of NewDeaths are actually negative (ex. Alaska 3/28)
# We have to set these to 0 before taking log(Y)
df[df$FutureDeathsPer100k < 0,"FutureDeathsPer100k"] = 0
Y = log(as.vector(df$FutureDeathsPer100k))
