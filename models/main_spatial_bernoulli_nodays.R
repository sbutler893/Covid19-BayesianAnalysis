# Model definition
description = "Bernoulli selectors without DaysSince10Deaths"
...
X = data.matrix(df[,!(names(df) %in% c("FutureDeathsPer100k", "DaysSince10Deaths", "Date","StateName","StateID"))])
